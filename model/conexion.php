...
class conexion {
    ...
    public function __construct() 
    {
        ...
        $this->usuario="root";
        $this->clave="";
        $this->baseDatos="ventamontura";
    }
    
    //Permite conectarme a la Base de datos
   ...
   //metodo que vuelve un registro : SELECT
   ...
   //metodo que vuelve un valor V-F : INSERT, UPDATE, DELETE
